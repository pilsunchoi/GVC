...
확장판에서만 공표치가 재현되므로 OECD가 공표 TiVA를 확장판 기준으로 계산하는 것으로 판단한다.
대조 결과에서 나온 추론이며, OECD 문서에서 이를 명시한 문장은 확인하지 못했다.
중국·멕시코뿐 아니라 다른 나라의 DVA/FVA도 확장판에서라야 정확히 맞는다(다른 나라의 수출에도
중국산 투입이 체화되어 있기 때문이다).
