...
$$
U_{kn} = \left( v^{(n)\prime} B \right)_k \qquad (1)
$$
...
$$
M_{n,c,d} = \sum_{k \in c} U_{kn} F_{k,d} \qquad (2)
$$
...
$$
M_{\text{CHN},\text{USA}} = \sum_n M_{n,\text{CHN},\text{USA}} = \sum_{k \in \text{CHN}} u_k F_{k,\text{USA}} \qquad (3)
$$
...
$$
G = \sum_{k \in \text{CHN}} u_k \left( \sum_{j \in \text{USA}} Z_{kj} + F_{k,\text{USA}} \right) \qquad (4)
$$
...
$$
\log(1 + M_{sit}) = \alpha_{si} + \delta_{st} + \beta \left( \text{post}_t \times \text{exposure}_i \right) + \varepsilon_{sit} \qquad (5)
$$
...
$$
\log(1 + M_{sit}) = \alpha_{si} + \delta_{st} + \sum_{y \neq 2017} \beta_y \left( \mathbf{1}\{t = y\} \times \text{exposure}_i \right) + \varepsilon_{sit} \qquad (6)
$$
